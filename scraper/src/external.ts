...
export const MANUAL_UPCOMING_EVENTS: StoredEvent[] = [
  {
    ...
    resultsUrl: "https://stopandgo.net/events/granfondo-terras-de-basto-2026",
    hasResults: false,
  ...
  },
  {
    ...
    date: "2026-07-05",
    location: "Sabugal",
    resultsUrl: "https://www.apedalar.pt",
    hasResults: false,
  ...
  },
  {
    ...
    date: "2026-07-26",
    location: "Paredes",
    resultsUrl: "https://stopandgo.net/events/granfondo-paredes-2026",
    hasResults: false,
    distances: [{ id: "1", name: "Granfondo" }, { id: "2", name: "Mediofondo" }, { id: "3", name: "Minifondo" }],
    participantCount: 0,
    finisherCount: 0,
  ...
  },
  {
    ...
    date: "2026-10-04",
    location: "Estremoz",
    resultsUrl: "https://stopandgo.net/events/granfondo-serra-dossa-2026",
    hasResults: false,
    distances: [{ id: "1", name: "Granfondo" }, { id: "2", name: "Mediofondo" }, { id: "3", name: "Minifondo" }],
    participantCount: 0,
    finisherCount: 0,
  ...
  },
  {
    ...
    date: "2026-11-08",
    location: "Portimão",
    resultsUrl: "https://stopandgo.net/events/granfondo-portimao-2026",
    hasResults: false,
    distances: [{ id: "1", name: "Granfondo" }, { id: "2", name: "Mediofondo" }, { id: "3", name: "Minifondo" }],
    participantCount: 0,
    finisherCount: 0,
