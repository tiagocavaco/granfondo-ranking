...
export type StoredParticipant = Omit<
  typeof schema.participants.$inferSelect,
  "id" | "eventId"
>;

// ── Event ─────────────────────────────────────────────────────────────────────

export type StoredDistance = Pick<
  typeof schema.eventDistances.$inferSelect,
  "id" | "name"
>;
 ...
 */
export type AthleteResultRef = Omit<
  AthleteResultsRow,
  "id" | "athleteId" | "dnf" | "dns"
> & {
  dnf: boolean;
  dns: boolean;
  bib: string;
 ...
 */
export type AthleteEntry = Omit<AthleteRow, "canonicalTeam"> & {
 ...
 */
export type AggregateAthlete = Omit<
  AggregateRow,
  "id" | "athleteId" | "year" | "distance"
> & {
 ...
 */
export type TeamEntry = Omit<TeamRow, "id" | "year" | "distance"> & {
