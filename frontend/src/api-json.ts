import type { StoredEvent, StoredEventResults, StoredParticipant, AggregateRanking, TeamRanking, AthleteEntry } from "@granfondo/db/types";
...
export const api = {
  ...
  getParticipants(id: number): Promise<StoredParticipant[]> {
    return getJson<StoredParticipant[]>(`/${id}_participants.json`);
  },
