      ...
      {results.map((r) => (
        ...
        >
          <div className="min-w-0">
            <div className="text-xs font-medium text-slate-700 truncate">{r.eventName}</div>
          ...
          <div className="flex items-center gap-2 shrink-0 text-xs">
            ...
            <span className="text-slate-400 hidden sm:inline">({r.distanceFinishers} fin.)</span>
            ...
            <React.Fragment key={a.id}>
              ...
              >
                ...
                <td className="px-2 sm:px-4 py-3 w-full max-w-0 overflow-hidden">
                  ...
                  >
                    <span className="mr-1.5" title={a.country}>{countryFlag(a.country)}</span>
                    {a.name}
                  </Link>
